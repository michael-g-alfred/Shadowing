...
enum APIEndpoints {
    ...
    static let userPath = userRoute + "/:id"
    static let userRatingsPath = userRoute + "/:id/ratings"
    
        // MARK: - Shared Tasks
    static let taskDetailsPath = taskRoute + "/tasks/:id"
    ...
    static let requesterDeleteTaskPath = taskRoute + "/req/delete/:id"
    
    static let requesterCancelTaskPath = taskRoute + "/req/:id/cancel"
    static let requesterPublishTaskPath = taskRoute + "/req/:id/publish"
    static let requesterConfirmTaskPath = taskRoute + "/req/:id/confirm"
    
    static let requesterApplicantsPath = taskRoute + "/req/:id/applicants"
    static let requesterAssignTaskPath = taskRoute + "/req/:id/assign"
    static let requesterDeclineApplicantPath = taskRoute + "/req/:id/decline/:applicantId"
    
    static let requesterRateExecutorPath = taskRoute + "/req/:id/rate"
    ...
    static let executorApplyTaskPath = taskRoute + "/exe/:id/apply"
    static let executorWithdrawTaskPath = taskRoute + "/exe/:id/withdraw"
    
    static let executorMarkDonePath = taskRoute + "/exe/:id/done"
    static let executorRateRequesterPath = taskRoute + "/exe/:id/rate"
    
        // MARK: - Admin
    
        // MARK: - Lookups
    static let lookupPath = lookupRoute + "/lookups"
    static let lookupTypePath = lookupRoute + "/lookups/:type"
