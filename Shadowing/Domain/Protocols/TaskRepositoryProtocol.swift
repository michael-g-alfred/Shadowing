...
protocol TaskRepositoryProtocol {
    ...
    func getAllTasks(cursor: String?, limit: Int?, search: String?) async throws -> PaginatedTasksResult
    ...
    func getPendingRatingsForRequester(cursor: String?, limit: Int?) async throws -> PaginatedTasksResult
        ...
        // NOTE: added `search: String?` — optional case-insensitive title/description
        // filter, forwarded straight through to the backend's `search` query param.
    func getExecutorAvailableTasks(cursor: String?, limit: Int?, favoritesOnly: Bool, search: String?) async throws -> PaginatedTasksResult
