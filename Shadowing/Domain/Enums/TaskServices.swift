...
enum TaskService: String, Codable, CaseIterable {
    ...
    var icon: String {
        switch self {
            ...
            case .catering: return "frying.pan.fill"
            ...
            case .dataEntry: return "keyboard.fill"
            ...
            case .giftSourcing: return "gift.fill"
            case .governmentServices: return "seal.fill"
            case .groceryDelivery: return "cart.fill"
            case .homeRepair: return "hammer.fill"
            case .itSupport: return "desktopcomputer"
            case .legalAssistance: return "building.columns.fill"
            case .marketing: return "megaphone.fill"
            case .medicalAppointment: return "cross.case.fill"
            case .mentalHealth: return "brain.head.profile"
            case .moving: return "house.and.flag.fill"
            case .packagePickup: return "shippingbox.fill"
            case .personalHelp: return "hand.raised.fill"
            ...
            case .returnItems: return "arrow.uturn.left.circle.fill"
